...
public class CustomRecipesBanners {
	/**
     * Adds the banner recipes to the CraftingManager.
     */
    void addRecipes(WorkbenchCraftingManager manager)
    {
        ...
        manager.addRecipe(new CustomRecipesBanners.RecipeDuplicatePattern());
        manager.addRecipe(new CustomRecipesBanners.RecipeAddPattern());
    }
