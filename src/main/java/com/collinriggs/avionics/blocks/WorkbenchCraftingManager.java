...
////        (new RecipesIngots()).addRecipes();
////        (new RecipesFood()).addRecipes();
////        (new RecipesCrafting()).addRecipes();
////        (new RecipesArmor()).addRecipes();
////        (new RecipesDyes()).addRecipes();
...
////        (new RecipesBanners()).addRecipes();
////        (new ShieldRecipes()).addRecipes();
